...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_scope_mosin"] = {model = "models/weapons/upgrades/a_optic_pu_sks.mdl", rLight = true, pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	}
...
SWEP.FireSound = "CW_KK_INS2_NAM_SKS_FIRE"
