...
SWEP.Attachments = {
	{header = "Reload Aid", offset = {500, 0}, atts = {/*"kk_ins2_revolver_mag", */"kk_ins2_ww2_stripper"}},
...
SWEP.ViewModel		= "models/weapons/cw_kk_doi/v_sw1917.mdl"
SWEP.WorldModel		= "models/weapons/w_sw1917.mdl"
